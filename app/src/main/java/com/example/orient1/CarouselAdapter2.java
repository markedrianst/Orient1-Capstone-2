...
public class CarouselAdapter2 extends RecyclerView.Adapter<CarouselAdapter2.CarouselViewHolder> {

    private List<Integer> imageList;
    private List<String> textList;
    private static final int LOOP_FACTOR = 1000;

    public CarouselAdapter2(List<Integer> imageList, List<String> textList) {
    ...
    public CarouselViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_carousel1, parent, false);
